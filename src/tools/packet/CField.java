...
public class CField {
    ...
    public static final byte[] Nexon_IP = new byte[]{(byte) 8, (byte) 31, (byte) 99, (byte) 141};//v143
	...
	mplew.writeInt(4648420); // acc id
	mplew.writeInt(565111); // char id
	mplew.writeLong(4);
	mplew.writeLong(9410165);
	mplew.writeLong(9410166);
	mplew.writeLong(9410167);
	mplew.writeLong(9410168);
...
//        }
        ...
        mplew.writeInt(0);//v155
	mplew.writeInt(4064);//v155 no idea
        ...
        mplew.writeZeroBytes(38); //v143 20->38 ty hawt
	...
	mplew.writeInt(0);
	mplew.writeInt(0);
	mplew.writeInt(Math.min(250, chr.getInventory(MapleInventoryType.CASH).countById(5110000))); //Valentine Effect - moved down by 2
	...
	mplew.writeInt(0);
	mplew.writeInt(0);//new 149 - idk pos
	mplew.writePos(chr.getTruePosition());
	mplew.write(chr.getStance());
	mplew.writeShort(chr.getStance() > 6 ? 254 : chr.getFH());//chr.getFH()); // LOL HAX
	mplew.write(0);//pet bool?
	mplew.write(0);
	mplew.write(0);
	mplew.write(1);
	mplew.write(0);
	...
	mplew.writeInt(chr.getMount().getFatigue());
        ...
        mplew.writeInt(0);
        mplew.write(0);
        mplew.writeInt(0);//new 145
	mplew.writeZeroBytes(15);//new 149 - idk pos
        mplew.writeInt(0);
