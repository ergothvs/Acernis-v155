...
//    }
    public static byte[] warpCS(MapleClient c) {
        ...
        mplew.write(HexTool.getByteArrayFromHexString("6D 00 61 00 67 00 65 00 3A 00 20 00 23 00 64 00 61 00 6D 00 61 00 67 00 65 00 25 00 2C 00 20 00 4E 00 75 00 6D 00 62 00 65 00 72 00 20 00 6F 00 66 00 20 00 41 00 74 00 74 00 61 00 63 00 6B 00 73 00 3A 00 20 00 23 00 61 00 74 00 74 00 61 00 63 00 6B 00 43 00 6F 00 75 00 6E 00 74 00 2E 00 20 00 43 00 61 00 6E 00 20 00 6F 00 6E 00 6C 00 79 00 20 00 62 00 65 00 20 00 75 00 73 00 65 00 64 00 20 00 77 00 68 00 65 00 6E 00 20 00 74 00 68 00 65 00 20 00 65 00 6E 00 65 00 72 00 67 00 79 00 20 00 69 00 73 00 20 00 64 00 72 00 61 00 69 00 6E 00 69 00 6E 00 67 00 20 00 61 00 66 00 74 00 65 00 72 00 20 00 23 00 63 00 61 00 20 00 66 00 75 00 6C 00 6C 00 20 00 63 00 68 00 61 00 72 00 67 00 65 00 23 00 2E 00 20 00 46 00 6F 00 72 00 20 00 23 00 74 00 69 00 6D 00 65 00 20 00 73 00 65 00 63 00 2C 00 20 00 74 00 68 00 65 00 20 00 65 00 78 00 63 00 6C 00 75 00 73 00 69 00 76 00 65 00 20 00 62 00 75 00 66 00 66 00 20 00 74 00 68 00 61 00 74 00 20 00 69 00 6E 00 63 00 72 00 65 00 61 00 73 00 65 00 73 00 20 00 4D 00 69 00 6E 00 20 00 43 00 72 00 69 00 74 00 69 00 63 00 61 00 6C 00 20 00 44 00 61 00 6D 00 61 00 67 00 65 00 20 00 61 00 6E 00 64 00 20 00 4D 00 61 00 78 00 20 00 44 00 61 00 6D 00 61 00 67 00 65 00 20 00 62 00 79 00 20 00 23 00 78 00 20 00 77 00 69 00 6C 00 6C 00 20 00 62 00 65 00 20 00 61 00 63 00 74 00 69 00 76 00 61 00 74 00 65 00 64 00 2E 00 20 00 41 00 62 00 6C 00 65 00 20 00 74 00 6F 00 20 00 73 00 74 00 61 00 63 00 6B 00 20 00 75 00 70 00 20 00 74 00 6F 00 20 00 33 00 20 00 74 00 69 00 6D 00 65 00 73 00 2E 00 5C 00 6E 00 43 00 6F 00 6F 00 6C 00 64 00 6F 00 77 00 6E 00 3A 00 20 00 23 00 63 00 6F 00 6F 00 6C 00 74 00 69 00 6D 00 65 00 20 00 73 00 65 00 63 00 00 00 00 00 00 00 00 00 56 00 00 56 4B FC B2 00 C8 89 C6 09 C0 F3 AB 37 65 00 72 00 67 00 79 00 20 00 43 00 6F 00 73 00 74 00 3A 00 20 00 23 00 66 00 6F 00 72 00 63 00 65 00 43 00 6F 00 6E 00 2C 00 20 00 4D 00 61 00 78 00 20 00 45 00 6E 00 65 00 6D 00 69 00 65 00 73 00 20 00 48 00 69 00 74 00 3A 00 20 00 23 00 6D 00 6F 00 62 00 43 00 6F 00 75 00 6E 00 74 00 2C 00 20 00 44 00 61 00 6D 00 61 00 67 00 65 00 3A 00 20 00 23 00 64 00 61 00 6D 00 61 00 67 00 65 00 25 00 2C 00 20 00 4E 00 75 00 6D 00 62 00 65 00 72 00 20 00 6F 00 66 00 20 00 41 00 74 00 74 00 61 00 63 00 6B 00 73 00 3A 00 20 00 23 00 61 00 74 00 74 00 61 00 63 00 6B 00 43 00 6F 00 75 00 6E 00 74 00 2E 00 20 00 43 00 61 00 6E 00 20 00 6F 00 6E 00 6C 00 79 00 20 00 62 00 65 00 20 00 75 00 73 00 65 00 64 00 20 00 77 00 68 00 65 00 6E 00 20 00 74 00 68 00 65 00 20 00 65 00 6E 00 65 00 72 00 67 00 79 00 20 00 69 00 73 00 20 00 64 00 72 00 61 00 69 00 6E 00 69 00 6E 00 67 00 20 00 61 00 66 00 74 00 65 00 72 00 20 00 23 00 63 00 61 00 20 00 66 00 75 00 6C 00 6C 00 20 00 63 00 68 00 61 00 72 00 67 00 65 00 23 00 2E 00 20 00 46 00 6F 00 72 00 20 00 23 00 74 00 69 00 6D 00 65 00 20 00 73 00 65 00 63 00 2C 00 20 00 74 00 68 00 65 00 20 00 65 00 78 00 63 00 6C 00 75 00 73 00 69 00 76 00 65 00 20 00 62 00 75 00 66 00 66 00 20 00 74 00 68 00 61 00 74 00 20 00 69 00 6E 00 63 00 72 00 65 00 61 00 73 00 65 00 73 00 20 00 4D 00 69 00 6E 00 20 00 43 00 72 00 69 00 74 00 69 00 63 00 61 00 6C 00 20 00 44 00 61 00 6D 00 61 00 67 00 65 00 20 00 61 00 6E 00 64 00 20 00 4D 00 61 00 78 00 20 00 44 00"));
        mplew.writeZeroBytes(7);
        mplew.write(100);//0x33
        mplew.writeInt(0);
        mplew.writeShort(0);//new 143
//        mplew.writeZeroBytes(6);
        mplew.writeLong(PacketHelper.getTime(System.currentTimeMillis()));
        mplew.writeZeroBytes(7);

        /*mplew.writeNullTerminatedCharString("g the skill, the nearby preset-up Poison Mists explode, dealing fatal damage to enemies. The damage will increase proportionate to the number of continuous damage effects applied to the target. You cannot detonate Mists set-up by others. The damage boost applies up to the 5th effect.\nRequired Skill: #cPoison Mist Lv. 20#");
         mplew.writeShort(0);
         mplew.writeShort(0x49);
         mplew.writeLong(0);
         mplew.writeShort(0);
         mplew.writeNullTerminatedCharString("MP Cost: #mpCon, Damage: #damage%, Max Enemies Hit: #mobCount, Number of Attacks: #attackCount, Damage Over Time: #dot% damage every #dotInterval sec for #dotTime sec, Freeze Chance: #hcProp%, Freeze Duration: ");
         mplew.writeZeroBytes(7);
         mplew.write(0xA1);
         mplew.writeInt(0);
         mplew.writeLong(PacketHelper.getTime(System.currentTimeMillis()));*/
...
//        System.out.println("string " + mplew.toString());
    ...
    public static byte[] getLogoutGift() {
        ...
        mplew.writeShort(SendPacketOpcode.LUCKY_LOGOUT.getValue());
